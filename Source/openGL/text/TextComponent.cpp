...
GLuint TextComponent::createTextureForTextUsingJuceTextRenderer(const char* textString)
{
    int imageWidth = 100;
    int imageHeight = 50;
    bool clearImage = true;
    imageForText = new Image( Image::ARGB, imageWidth, imageHeight, clearImage );
...
struct TextComponent::OpenGLGlyphTextureInfo
{
    GLuint textureId;
    float textureWidth;
    float textureHeight;
...
std::map<int, TextComponent::OpenGLGlyphTextureInfo> TextComponent::createBitmapFontUsingJuceTextRenderer()
{
    ...
    for (int asciiCode = firstAndLastAsciiCode.first; asciiCode <= firstAndLastAsciiCode.second; asciiCode++)
    {
        ...
        bool clearImage = true;
        imageForText = new Image( Image::ARGB, ceil(imageWidth), ceil(imageHeight), clearImage );
...
void TextComponent::drawTextWithBitmapFont(const String& message, int startX, int startY)
{
...
void TextComponent::newOpenGLContextCreated()
{
   ...
   // Load the vertex/fragment shaders
    ...
    juceLogoTextureId = createTextureForTextUsingJuceTextRenderer("Message printed using the Juce text renderer.");
...
void TextComponent::createFreeTypeFontAtlas()
{
...
void TextComponent::openGLContextClosing()
{
}
...
void TextComponent::renderOpenGL()
{
    ...
    */
    ...
    if (environment != NULL)
    {
        ...
        int black = 0;
        arialFont->drawString(*environment.get(), 5, 0, "This was drawn with a text atlas renderer.", black);
