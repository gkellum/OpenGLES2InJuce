...
TextWithJuceFontAtlasComponent::~TextWithJuceFontAtlasComponent() noexcept
{
...
std::map<int, TextWithJuceFontAtlasComponent::OpenGLGlyphTextureInfoPtr> TextWithJuceFontAtlasComponent::createBitmapFontUsingJuceTextRenderer()
{
    ...
    for (int asciiCode = firstAndLastAsciiCode.first; asciiCode <= firstAndLastAsciiCode.second; asciiCode++)
    {
        ...
        */
        ...
        OpenGLGlyphTextureInfoPtr textureInfo(new OpenGLGlyphTextureInfo());
...
int TextWithJuceFontAtlasComponent::drawTextWithBitmapFont(const String& textMessage, int startX, int startY)
{
    ...
    std::map<int, OpenGLGlyphTextureInfoPtr>::iterator it;
    for (int indexOfCharacter = 0; indexOfCharacter < stringLength; indexOfCharacter++)
    {
        ...
        OpenGLGlyphTextureInfoPtr textureInfo = it->second;
